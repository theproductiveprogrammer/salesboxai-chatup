    ...
    <div className="flex h-full flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 h-full px-8 overflow-y-auto flex flex-col gap-8 justify-center">
        ...
        >
          ...
          <div className="mb-12 flex justify-center">
            <div className="relative group">
              <img
                ...
                className="w-28 h-28 md:w-36 md:h-36 drop-shadow-lg transition-all duration-500 group-hover:scale-110 group-hover:rotate-3"
              />
              {/* Subtle glow effect */}
          ...
          {/* Welcome Message */}
          <div className="mb-16">
            <h1 className="font-editorialnew text-main-view-fg text-5xl md:text-6xl mb-6 font-bold bg-gradient-to-r from-main-view-fg to-main-view-fg/80 bg-clip-text text-transparent">
              {t('setup:welcome')}
            </h1>
          ...
          {hasValidProviders && onProceed && (
            <div className="mb-12">
              <button
                onClick={onProceed}
                className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-10 py-4 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 text-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 active:scale-95"
              >
                🚀 Continue to Chat
              </button>
