				...
				>
					...
					<div className="mb-12">
						...
						<p className="text-main-view-fg/70 text-lg max-w-lg mx-auto">
							We're downloading <span className="font-semibold">{modelName}</span>{' '}
							for you. This will only take a moment...
						</p>
					</div>
							...
							<div className="grid grid-cols-3 gap-4 pt-4 border-t border-main-view-fg/10">
								<div className="text-center">
									<div className="text-2xl font-bold text-blue-500">
										...
										<span className="text-sm text-main-view-fg/60 ml-1">GB</span>
									</div>
