...
# SalesBox.AI - Reset Script for Debug Build
# This script clears all app data including localStorage (Tauri store)

echo "🔄 SalesBoxAI - Reset Debug Build"
echo "===================================="
echo ""

APP_NAME="salesbox.ai.agent.dev"  # Debug/Development build identifier

echo "📦 Resetting: $APP_NAME (Debug Build)"
echo ""
...
rm -rf ./web-app/dist ./web-app/node_modules/.vite
...
echo ""
echo "💡 Tip: You can also clear localStorage via DevTools in debug build:"
echo "   1. Open app"
echo "   2. Press Cmd+Option+I to open DevTools"
echo "   3. Console tab: localStorage.clear(); location.reload()"
echo ""
